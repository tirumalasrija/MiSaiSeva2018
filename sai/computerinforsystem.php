...
<?php
/* Template Name: computernetworksystem
    ...
    <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/inne-banner.jpg);">
        <div class="container">
            <div class="dez-bnr-inr-entry">
                <h1 class="text-white">Computer network system (CNS) </h1>
                <ul class="list-inline">
                    <li><a href="#">Home</a></li>
                    <li>Programs</li>
                    <li>Computer network system (CNS) </li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 m-b30">
                    <h1 class="m-b20">Computer network system (CNS) </h1>
