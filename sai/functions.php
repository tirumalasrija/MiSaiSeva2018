...
function codex_project_init() {
        $labels = array(
		'name'               => _x( 'lquotes', 'post type general name', 'canvas' ),
		'singular_name'      => _x( 'lquote', 'post type singular name', 'canvas' ),
		'menu_name'          => _x( 'lquotes', 'admin menu', 'canvas' ),
		'name_admin_bar'     => _x( 'lquote', 'add new on admin bar', 'canvas' ),
		'add_new'            => _x( 'Add New', 'lquote', 'canvas' ),
		'add_new_item'       => __( 'Add New lquote', 'canvas' ),
		'new_item'           => __( 'New lquote', 'canvas' ),
		'edit_item'          => __( 'Edit lquote', 'canvas' ),
		'view_item'          => __( 'View lquote', 'canvas' ),
		'all_items'          => __( 'All lquotes', 'canvas' ),
		'search_items'       => __( 'Search lquotes', 'canvas' ),
		'parent_item_colon'  => __( 'Parent lquotes:', 'canvas' ),
		'not_found'          => __( 'No lquotes found.', 'canvas' ),
		'not_found_in_trash' => __( 'No lquotes found in Trash.', 'canvas' )
	);
	...
	register_post_type( 'lquotes', $args );
      
        $labels = array(
		'name'               => _x( 'rquotes', 'post type general name', 'canvas' ),
		'singular_name'      => _x( 'rquote', 'post type singular name', 'canvas' ),
		'menu_name'          => _x( 'rquotes', 'admin menu', 'canvas' ),
		'name_admin_bar'     => _x( 'rquote', 'add new on admin bar', 'canvas' ),
		'add_new'            => _x( 'Add New', 'rquote', 'canvas' ),
		'add_new_item'       => __( 'Add New rquote', 'canvas' ),
		'new_item'           => __( 'New rquote', 'canvas' ),
		'edit_item'          => __( 'Edit rquote', 'canvas' ),
		'view_item'          => __( 'View rquote', 'canvas' ),
		'all_items'          => __( 'All rquotes', 'canvas' ),
		'search_items'       => __( 'Search rquotes', 'canvas' ),
		'parent_item_colon'  => __( 'Parent rquotes:', 'canvas' ),
		'not_found'          => __( 'No rquotes found.', 'canvas' ),
		'not_found_in_trash' => __( 'No rquotes found in Trash.', 'canvas' )
	);
	...
	register_post_type( 'rquotes', $args );
      
          
    $labels = array(
		'name'               => _x( 'features', 'post type general name', 'canvas' ),
		'singular_name'      => _x( 'feature', 'post type singular name', 'canvas' ),
		'menu_name'          => _x( 'features', 'admin menu', 'canvas' ),
		'name_admin_bar'     => _x( 'feature', 'add new on admin bar', 'canvas' ),
		'add_new'            => _x( 'Add New', 'feature', 'canvas' ),
		'add_new_item'       => __( 'Add New feature', 'canvas' ),
		'new_item'           => __( 'New feature', 'canvas' ),
		'edit_item'          => __( 'Edit feature', 'canvas' ),
		'view_item'          => __( 'View feature', 'canvas' ),
		'all_items'          => __( 'All features', 'canvas' ),
		'search_items'       => __( 'Search features', 'canvas' ),
		'parent_item_colon'  => __( 'Parent features:', 'canvas' ),
		'not_found'          => __( 'No teams found.', 'canvas' ),
		'not_found_in_trash' => __( 'No features found in Trash.', 'canvas' )
	);
    ...
    register_post_type( 'slide', $args );
            ...
            $labels = array(
        'name'               => _x( 'featureSliders', 'post type general name', 'canvas' ),
        'singular_name'      => _x( 'featureSlide', 'post type singular name', 'canvas' ),
        'menu_name'          => _x( 'featureSliders', 'admin menu', 'canvas' ),
        'name_admin_bar'     => _x( 'featureSlide', 'add slide on admin bar', 'canvas' ),
        'add_new'            => _x( 'Add featureSlide', 'slide', 'canvas' ),
        'add_new_item'       => __( 'Add featureSlide featureSlide', 'canvas' ),
        'new_item'           => __( 'featureSlide featureSlide', 'canvas' ),
        'edit_item'          => __( 'Edit featureSlide', 'canvas' ),
        'view_item'          => __( 'View featureSlide', 'canvas' ),
        'all_items'          => __( 'All featureSliders', 'canvas' ),
        'search_items'       => __( 'Search featureSliders', 'canvas' ),
        'parent_item_colon'  => __( 'Parent featureSliders:', 'canvas' ),
        'not_found'          => __( 'No featuresliders found.', 'canvas' ),
        'not_found_in_trash' => __( 'No featuresliders found in Trash.', 'canvas' )
    );
    ...
    register_post_type( 'featureslide', $args );
  }
